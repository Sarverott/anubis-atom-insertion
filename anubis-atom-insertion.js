  ...
  static INIT(){
    ...
    if(fs.existsSync(path.join(os.homedir(), ".atom"))){
      ...
      if(fs.readFileSync(
        ...
        return line=='(require "'+AnubisAtomProjectGuard.SCRIPTNAME()+'").INSET(atom) #ANUBIS-COMMANDING-SYSTEM-CODE-INSERTION';
      })==-1){
        try {
          fs.appendFileSync(path.join(
              ...
              ".atom",
              "init.coffee"
            ), '\n(require "'+AnubisAtomProjectGuard.SCRIPTNAME()+'").INSET(atom) #ANUBIS-COMMANDING-SYSTEM-CODE-INSERTION\n');
